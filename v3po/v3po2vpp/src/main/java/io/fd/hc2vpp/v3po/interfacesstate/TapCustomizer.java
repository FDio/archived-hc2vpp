...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.v3po.rev170315.interfaces.state._interface.TapBuilder;
...
public class TapCustomizer extends FutureJVppCustomizer
    ...
    public void readCurrentAttributes(@Nonnull final InstanceIdentifier<Tap> id,
        ...
        if (!isInterfaceOfType(getFutureJVpp(), ctx.getModificationCache(), id, index,
                org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.v3po.rev170315.Tap.class, LOG)) {
            return;
        }
    ...
    @Override
    public Initialized<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.v3po.rev170315.interfaces._interface.Tap> init(
        ...
        return Initialized.create(getCfgId(id),
                new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.v3po.rev170315.interfaces._interface.TapBuilder()
...
//                            tapBuilder.setDeviceInstance();
    ...
    private InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.v3po.rev170315.interfaces._interface.Tap> getCfgId(
            final InstanceIdentifier<Tap> id) {
        return InterfaceCustomizer.getCfgId(RWUtils.cutId(id, Interface.class))
                .augmentation(VppInterfaceAugmentation.class)
                .child(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.v3po.rev170315.interfaces._interface.Tap.class);
    }
}
