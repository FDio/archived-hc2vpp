...
public class AfPacketCustomizer implements InitializingReaderCustomizer<AfPacket, AfPacketBuilder>,
    ...
    public void readCurrentAttributes(@Nonnull final InstanceIdentifier<AfPacket> id,
        ...
        if (!isInterfaceOfType(
            org.opendaylight.yang.gen.v1.http.fd.io.hc2vpp.yang.v3po.rev190128.AfPacket.class,
            ifcDetails)) {
            return;
        }
    ...
    @Nonnull
    @Override
    public Initialized<org.opendaylight.yang.gen.v1.http.fd.io.hc2vpp.yang.v3po.rev190128.interfaces._interface.AfPacket> init(
    ...
    @VisibleForTesting
    static InstanceIdentifier<org.opendaylight.yang.gen.v1.http.fd.io.hc2vpp.yang.v3po.rev190128.interfaces._interface.AfPacket> getCfgId(
        final InstanceIdentifier<AfPacket> id) {
        return InterfaceCustomizer.getCfgId(RWUtils.cutId(id, Interface.class))
            .augmentation(VppInterfaceAugmentation.class)
            .child(
                org.opendaylight.yang.gen.v1.http.fd.io.hc2vpp.yang.v3po.rev190128.interfaces._interface.AfPacket.class);
    }
}
