...
public class SubInterfaceIpv6WriterFactory implements WriterFactory {
    ...
    public void init(@Nonnull final ModifiableWriterRegistryBuilder registry) {
        ...
        final InstanceIdentifier<Address>
                ...
                .child(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.vpp.vlan.rev170607.sub._interface.ip6.attributes.ipv6.Address.class);
        ...
        final InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.vpp.vlan.rev170607.sub._interface.ip6.attributes.ipv6.Neighbor>
                ipv6NeighborId = SUB_IFC_ID.child(Ipv6.class)
                .child(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.vpp.vlan.rev170607.sub._interface.ip6.attributes.ipv6.Neighbor.class);
