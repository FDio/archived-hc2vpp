...
public class EidTranslatorTest implements EidTranslator {
    ...
    public void testGetEidType() {
        assertEquals(IPV4, getEidType(
                new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.lisp.rev170803.dp.subtable.grouping.remote.mappings.remote.mapping.EidBuilder()
    ...
    public void testGetPrefixLength() {
        assertEquals(32, getPrefixLength(
                new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.lisp.rev170803.dp.subtable.grouping.local.mappings.local.mapping.EidBuilder()
                        .setAddress(IPV4_ADDRESS).build()));
