...
public class MappingProducerTest implements MappingProducer {
    ...
    public void init() {
        ...
        ipv4RemoteMapping = new RemoteMappingBuilder()
                .setEid(new org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.lisp.rev170911.dp.subtable.grouping.remote.mappings.remote.mapping.EidBuilder()
