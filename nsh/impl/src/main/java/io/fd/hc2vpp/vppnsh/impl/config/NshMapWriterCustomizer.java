...
import org.opendaylight.yang.gen.v1.http.fd.io.hc2vpp.yang.vpp.nsh.rev170315.vpp.nsh.nsh.maps.NshMap;
import org.opendaylight.yang.gen.v1.http.fd.io.hc2vpp.yang.vpp.nsh.rev170315.vpp.nsh.nsh.maps.NshMapKey;
...
implements ListWriterCustomizer<NshMap, NshMapKey>, ByteDataTranslator, JvppReplyConsumer {
    ...
    private NshAddDelMap getNshAddDelMapRequest(final boolean isAdd, final int mapIndex,
        ...
        if (map.getEncapType() == VxlanGpe.class) {
            request.nextNode = 2;
        } else if (map.getEncapType() == Vxlan4.class) {
            request.nextNode = 3;
