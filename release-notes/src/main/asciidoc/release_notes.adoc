...
== Features
Adding to the list of existing features: https://docs.fd.io/hc2vpp/1.19.01/hc2vpp-parent/release-notes-aggregator/release_notes.html#_features[1901 feature list]:

=== New features

* https://jira.fd.io/browse/HC2VPP-372[Add support for Ubuntu 18.04 (Bionic Beaver)]
* https://jira.fd.io/browse/HC2VPP-378[Validation support part I]
* https://jira.fd.io/browse/HC2VPP-400[Java 11 integration]
* https://jira.fd.io/browse/HC2VPP-404[JVPP integration]
* https://jira.fd.io/browse/HC2VPP-406[fix bugs after bump to ODL neon]
